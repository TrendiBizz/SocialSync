...
import { store as assigneeStore } from 'fe-lib-assignee-store';
...
var teammanagement = {
    ...
    removeSocialNetwork: function (snIds, callback) {
        modals.RemoveConfirmationModal(snIds, callback);
    },
    ...
    removeUserFromOrganization: function (organizationId, memberId, callback) {
        ...
        ajaxCall({
            ...
            success: function (data) {
                if (data.success) {
                    hs.statusObj.update(translation._("Success"), 'success', true, 4000);
                    hootbus.emit(events.REMOVE_MEMBER_SUCCESS)
                    _.isFunction(callback) && callback(data);
    ...
    removeMemberFromTeam: function (teamId, memberIds, revokeSnPermission, callback) {
        ...
        ajaxCall({
            ...
            success: function (data) {
                if (data.success) {
                    hs.statusObj.update(translation._("Success"), 'success', true, 4000);
                    assigneeStore.getState().resetAssignees({});
                    _.isFunction(callback) && callback(data);
                } else {
